...
function syncAndRender() {
    ...
    // ✅ remplacé par Layout
    (0, _layoutJs.Layout).applyChartAutoHeight();
...
},{"./state.js":"eTxS5","./readers.js":"10h2b","./chartRenderer.js":"9eLeu","./ui.js":"25UgT","./drawings.js":"8eWms","./grid.js":"alXmK","./layout.js":"kkJAL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"10h2b":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const Layout = {
    ...
    applyChartAutoHeight () {
        const itemCount = Array.isArray((0, _stateJs.State).rows) ? (0, _stateJs.State).rows.length : 0;
        const density = (0, _stateJs.State).layout?.density || "standard";
        const h = Layout.getAutoChartHeightPx(itemCount, density);
        const wrap = (0, _domJs.DOM).canvas?.parentElement; // ou DOM.canvasWrap si tu l’as
        if (!wrap) return;
        wrap.style.height = `${h}px`;
        if ((0, _stateJs.State).chart) (0, _stateJs.State).chart.resize();
    }
};
    ...
    init () {
        ...
        document.addEventListener("click", (e)=>{
            ...
            if (action === "delete-respondent") {
                ...
                (0, _syncJs.syncAndRender)(); // relit, update chart + applyGridColumns()
                return;
            }
            ...
            if (action === "export-chart") {
                (0, _exportJs.ExportActions).exportChartPng();
                return;
            }
        });
    }
...
const TemplateActions = {
    apply (templateId) {
        ...
        if (!tpl) return;
        // 1) Chart type
        (0, _stateJs.State).chartType = tpl.chartType;
    ...
    ensureRespondentCount (targetCount) {
        ...
        (0, _syncJs.syncAndRender)(); // refresh State.respondents
